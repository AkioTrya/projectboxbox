...
const teams = [
    { 
        ...
        history: "Born from the Jaguar Racing team, Red Bull has become a dominant force in the hybrid era." 
    },
    { 
        name: "Ferrari", 
        slug: "ferrari", 
        ...
        history: "The only team to have competed in every season of the Formula One World Championship." 
    },
    { 
        name: "Mercedes", 
        slug: "mercedes", 
        ...
        founded: "1954", 
        base: "Brackley, UK",
        history: "A heritage of engineering excellence, dominating the early turbo-hybrid era with 8 consecutive titles." 
    },
    { 
        name: "McLaren", 
        slug: "mclaren", 
        ...
        founded: "1963", 
        base: "Woking, UK",
        history: "Founded by Bruce McLaren, it is the second oldest active team after Ferrari." 
    },
    { 
        name: "Aston Martin", 
        slug: "aston-martin", 
        ...
        founded: "1959", 
        base: "Silverstone, UK",
        history: "Rebranded from Racing Point, carrying the legendary British Racing Green into the modern era." 
    },
    { 
        name: "Alpine", 
        slug: "alpine", 
        ...
        founded: "1981", 
        base: "Enstone, UK",
        history: "Formerly Renault and Toleman, Alpine represents the French sporting excellence in F1." 
    },
    { 
        name: "Williams", 
        slug: "williams", 
        ...
        founded: "1977", 
        base: "Grove, UK",
        history: "One of the most successful privateer teams in F1 history, founded by Sir Frank Williams." 
    },
    { 
        name: "RB", 
        slug: "rb", 
        ...
        founded: "1985", 
        base: "Faenza, Italy",
        history: "Starting as Minardi, then Toro Rosso and AlphaTauri, it serves as Red Bull's talent pipeline." 
    },
    { 
        name: "Kick Sauber", 
        slug: "kick-sauber", 
        ...
        history: "A Swiss-based team with deep engineering roots, currently transitioning into the Audi era." 
    },
    { 
        name: "Haas", 
        slug: "haas", 
        ...
        founded: "2016", 
        base: "Kannapolis, USA",
        history: "The only American team on the grid, utilizing a unique partnership model with Ferrari and Dallara." 
    },
];
            ...
            <div className="max-w-6xl mx-auto flex flex-col gap-10">
                <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <p className="text-f1-red font-display tracking-widest text-xs uppercase">Constructors</p>
                    </div>
                        ...
                        >
                            ...
                            <div className="flex justify-between items-start">
                                ...
                                >
                                    <span className="text-xs font-display font-bold opacity-40 group-hover:opacity-100 transition-opacity">
                                        {team.slug.split('-').map(s => s[0]).join('').toUpperCase()}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="mt-auto pt-6 border-t border-pit-border/50 flex justify-between items-center">
                                <div className="flex gap-2">
                                    <div className="w-6 h-6 border border-pit-border" style={{ backgroundColor: team.color }} title="Primary Color"></div>
                                    <div className="w-6 h-6 border border-pit-border" style={{ backgroundColor: team.accent }} title="Accent Color"></div>
                                </div>
                                <a 
