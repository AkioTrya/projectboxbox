...
const educationTopics = [
  {
    ...
    content:
      "On a telemetry chart, the Y-axis represents time (lower is faster) and the X-axis represents lap numbers. Look for consistency in the line's height. Sudden spikes usually indicate a pit stop or a yellow flag period.",
    icon: "📈",
  },
  {
    title: "Identifying the 'Undercut'",
    content:
      "If a driver pits 1-2 laps before their rival and starts setting personal best sectors (watch for green/purple indicators), they are attempting an undercut. On our dashboard, you'll see their line drop significantly while the rival's line stays flat.",
    icon: "✂️",
  },
  {
    title: "Tyre Life vs. Pace",
    content:
      "As tyres age (Tyre Life increases), their grip decreases, leading to slower lap times. Switch the dashboard focus to 'Tyre' to see how many laps a compound has done and how it correlates with the pace drop-off.",
    icon: "🛞",
  },
  {
    title: "Syncing with Live Races",
    content:
      "While watching a live race, keep an eye on the gap between drivers. Use the 'Pace Distribution' view to see which driver has the better average speed. If one driver's distribution is shifted significantly left (faster) than the driver ahead, an overtake is likely imminent.",
    icon: "📺",
  },
];
      ...
      <div className="max-w-4xl mx-auto flex flex-col gap-12">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-f1-gray text-lg max-w-2xl mt-2 italic font-display">
            "Telemetry is the heartbeat of the pit wall. Understanding it turns
            you from a spectator into a strategist."
          </p>
        </div>
        ...
        <div className="p-8 border-2 border-dashed border-pit-border bg-f1-red/5 flex flex-col gap-4 items-center text-center">
          <p className="text-f1-white font-display text-lg">
            READY TO APPLY YOUR KNOWLEDGE?
          </p>
          <p className="text-f1-gray text-sm max-w-lg">
            Head over to the Dashboard, select a historic session, and try to
            identify the winning strategy based on the telemetry data.
          </p>
          <a
            href="/dashboard"
